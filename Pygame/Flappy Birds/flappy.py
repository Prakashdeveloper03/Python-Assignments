...
def main():
    ...
    SOUNDS["die"] = pygame.mixer.Sound(f"assets/audio/die{soundExt}")
    SOUNDS["hit"] = pygame.mixer.Sound(f"assets/audio/hit{soundExt}")
    SOUNDS["point"] = pygame.mixer.Sound(f"assets/audio/point{soundExt}")
    SOUNDS["swoosh"] = pygame.mixer.Sound(f"assets/audio/swoosh{soundExt}")
    SOUNDS["wing"] = pygame.mixer.Sound(f"assets/audio/wing{soundExt}")
